...
// console.log("hellooo " + formData)
    ...
    //    }
       ...
       try {
           ...
           if(result?.id) navigate(`/events/${result.id}`)
           else console.error('Failed to generate event')
       } catch (e) {
    ...
    return (
        <main className="flex flex-col gap-10 pb-20 wrapper">
            <Header title="Add Event" description="View and edit AI Generated travel plans" />
