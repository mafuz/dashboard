...
import {cn, parseEventData} from "lib/utils";
import {Header, EventCard} from "../../../components";
import {getAllEvents} from "~/appwrite/events";
import type {Route} from "../../../.react-router/types/app/routes/admin/+types/events";
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
    ...
    const [user, { allEvents, total } ] = await Promise.all([
        getUser(),
    ...
    return (
        <main className="flex flex-col">
                    ...
                    <section className="wrapper">
                        <article>
                            ...
                            <p className="text-dark-100">
                                Customize your event itinerary in minutes—pick your destination, set your preferences, and explore with confidence.
                            </p>
                        </article>
            ...
            <section className="pt-20 wrapper flex flex-col gap-10 h-full">
                <Header title="Featured Event Location" description="Check out some of the best events you will like to experience" />
            ...
            <section id="trips" className="py-20 wrapper flex flex-col gap-10">
                <Header title="Handpicked Events" description="Browse well-planned events designes for your satisfaction" />
